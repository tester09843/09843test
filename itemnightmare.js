const itemDatabase = {
    ...
    "anti-flesh rifle": { name: "Anti-Flesh Rifle", type: "Weapon", damage: 18, firerate: 600, hasSpecialAbility: false },
    "rifle (old model)": { name: "Rifle (Old Model)", type: "Weapon", damage: 18, firerate: 600, hasSpecialAbility: false },
    ...
    "hallsweeper (old)": { name: "Hallsweeper (Old)", type: "Weapon", damage: 130, firerate: 120, hasSpecialAbility: false },
    ...
    "handyman": { name: "Handyman", type: "Weapon", damage: 110, firerate: 50, hasSpecialAbility: false },
    ...
    "grenadiers choice": { name: "Grenadiers Choice", type: "Weapon", damage: 107, firerate: 70, hasSpecialAbility: false },
    ...
    "mini smgs": { name: "Mini smgs", type: "Weapon", damage: 22, firerate: 800, hasSpecialAbility: false },
    "bloodshot": { name: "Bloodshot", type: "Weapon", damage: 28, firerate: 400, hasSpecialAbility: false },
    "mini smgs (old)": { name: "Mini smgs (Old)", type: "Weapon", damage: 18, firerate: 800, hasSpecialAbility: false },
    ...
    "surveillance creed": { name: "Surveillance Creed", type: "Weapon", damage: 25, firerate: 600, hasSpecialAbility: true },
    ...
    "stonewall (old)": { name: "Stonewall (Old)", type: "Weapon", damage: 24, firerate: 350, hasSpecialAbility: false },
    ...
    "shockwave device (old)": { name: "Shockwave Device (Old)", type: "Weapon", damage: 1500, firerate: 30, hasSpecialAbility: false },
    ...
    "adhe launcher": { name: "Adhe Launcher", type: "Weapon", damage: 110, firerate: 90, hasSpecialAbility: true },
    "adhe launcher (old method)": { name: "Adhe Launcher (Old Method)", type: "Weapon", damage: 40, firerate: 90, hasSpecialAbility: true },
    "adhe infinite": { name: "Adhe Infinite", type: "Weapon", damage: 110, firerate: 1000, hasSpecialAbility: true },
    ...
    "adc kit": { name: "ADC kit", type: "Weapon", damage: 0, firerate: 0, hasSpecialAbility: false },
    "turret kit": { name: "Turret kit", type: "Weapon", damage: 5, firerate: 600, hasSpecialAbility: false },
    "sprayer kit": { name: "Sprayer kit", type: "Weapon", damage: 20, firerate: 60, hasSpecialAbility: false },
    ...
    "a-10 machine gun": { name: "A-10 Machine Gun", type: "Weapon", damage: 18, firerate: 150, hasSpecialAbility: false },
    ...
    "shovel (old method)": { name: "Shovel (Old Method)", type: "Melee", damage: 101, firerate: 0.7, hasSpecialAbility: false },
    "overcharger (old)": { name: "Overcharger (Old)", type: "Melee", damage: 101, firerate: 0.7, hasSpecialAbility: true },
    ...
    "wrench": { name: "Wrench", type: "Melee", damage: 54, firerate: 0.5, hasSpecialAbility: true },
    "stick grenade": { name: "Stick Grenade", type: "Melee", damage: 30, firerate: 0.5, hasSpecialAbility: true },
    "ammo box": { name: "Ammo box", type: "Utility", damage: 0, firerate: 6, hasSpecialAbility: false },
    "ammo box (ammo)": { name: "Ammo box (Ammo)", type: "Utility", damage: 0, firerate: 0, hasSpecialAbility: false },
    "combat toolkit": { name: "Combat Toolkit", type: "Utility", damage: 0, firerate: 3, hasSpecialAbility: false },
    "combat toolkit (ammo)": { name: "Combat Toolkit (Ammo)", type: "Utility", damage: 0, firerate: 3, hasSpecialAbility: false },
    ...
    "ammo box (old)": { name: "Ammo box (Old)", type: "Utility", damage: 0, firerate: 6, hasSpecialAbility: false },
    ...
    "terminal velocity (old)": { name: "Terminal Velocity (Old)", type: "Utility", damage: 0, firerate: 0, hasSpecialAbility: false },
    "exoskeleton": { name: "Exoskeleton", type: "Utility", damage: 450, firerate: 3, hasSpecialAbility: false },
    "shurarig": { name: "Shurarig", type: "Utility", damage: 150, firerate: 10, hasSpecialAbility: false },
    ...
    "fractionate": { name: "Fractionate", type: "Utility", damage: 0, firerate: 1, hasSpecialAbility: false },
    "aidkit (charges)": { name: "Aidkit (Charges)", type: "Utility", damage: 0, firerate: 2, hasSpecialAbility: false },
    "mercy kill (old)": { name: "Mercy Kill (Old)", type: "Utility", damage: 0, firerate: 26, hasSpecialAbility: false },
    ...
    "artillery tablet": { name: "Artillery Tablet", type: "Utility", damage: 0, firerate: 0, hasSpecialAbility: false },
